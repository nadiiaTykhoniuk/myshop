    ...
    implements Iface
{
    ...
    public function getBody( string $uid = '' ) : string
    {
        ...
        $tplconf = 'client/html/test/customized/template-body';
        $default = 'test/customized/body-standard';
    ...
    public function getHeader( $uid = '' ) : ?string
    {
        ...
        $tplconf = 'client/html/test/customized/template-header';
        $default = 'test/customized/header-standard';
