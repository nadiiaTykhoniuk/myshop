    ...
    implements \Aimeos\Client\Html\Common\Factory\Iface
{
    ...
    {
        if( $name == null ) {
            $name = $context->getConfig()->get( 'client/html/basket/customized/name', 'Standard' );
        }

        $iface = '\\Aimeos\\Client\\Html\\Iface';
        $classname = '\\Aimeos\\Client\\Html\\Basket\\Customized\\' . $name;
        ...
        $client = self::addClientDecorators( $context, $client, 'basket/customized' );
