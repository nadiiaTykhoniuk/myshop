				...
				@else
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							@endif
                                <li><a class="nav-link" href="{{ route('aimeos_shop_admin',['site'=>Route::current()->parameter('site','default'),'locale'=>Route::current()->parameter('locale'),'currency'=>Route::current()->parameter('currency','EUR')]) }}" title="{{ __('Profile') }}">{{ __('Profile') }}</a></li>
